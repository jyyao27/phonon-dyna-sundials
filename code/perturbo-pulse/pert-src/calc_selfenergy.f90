...
!> Sets up and performs calculation of the imaginary part of the off-shell (frequency dependent) electron self-energy in the
!! Fan-Migdal approximation. Corresponds to Perturbo calculation mode `spectral-se`.
!! Numerical evaluation of the self-energy uses <selfenergy>::selfenergy_fan in selfenergy.f90. 
